  ...
  test.beforeAll(async ({ request }) => {
    try {
      ...
      if (!createTenantResponse.ok()) {
        const responseText = await createTenantResponse.text();
        console.error(`Create Tenant Response Body: ${responseText}`);
      }
      expect(createTenantResponse.ok()).toBeTruthy();
      
      let createdTenant = await createTenantResponse.json();
